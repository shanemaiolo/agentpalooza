...
- If you catch yourself about to write elsewhere, STOP and correct the path
...
The prompt you receive will contain a `**Report Configuration**` block prepended by the main instance. Parse it to extract:
