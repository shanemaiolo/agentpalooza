...
A multi-agent research toolkit that coordinates comprehensive research with built-in fact-checking:
...
```
User Request → @research-assistant → @research-report-generator → @research-fact-checker
                                              ↑                            │
                                              └──── REJECT (retry) ────────┘
```
